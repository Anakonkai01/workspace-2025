...
CLAHE_TILE_GRID_SIZE = (8, 8)  # Tile grid size for CLAHE (adaptive histogram equalization)
...
# --- Processing Limit ---
MAX_FRAME_ID = 10000  # Stop detection at this frame

# --- Debug Mode Toggle ---
DEBUG_MODE = True  # Set to False to disable ROI boxes and metrics overlay

# --- File Paths ---
INPUT_VIDEO_PATH = 'video/video2.mp4'
